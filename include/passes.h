...
{ 
    ...
    PASS_DETECT_BUILTIN_COMMANDS,
    PASS_EXECUTE_CONVEYOR, /* will be added */
    PASS_EXECUTE_BUILTIN_COMMAND, /* will be removed */
    PASS_EXECUTE_EXTERNAL_COMMAND, /* will be removed */
